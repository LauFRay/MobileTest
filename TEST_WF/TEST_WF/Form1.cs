...
namespace TEST_WF
{
    public partial class Form1 : Form
    {
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        public int[] randomiseQuestion(bool activ, int[] sequence)
        {
        ...
        private void btnOpen_Click(object sender, EventArgs e)
        {
            ...
            TestBegin(Qnum,randomiseQuestion(randQuestion.Checked,TestSequence));
            btnHelp.Text = "ОТВЕТ";
            this.Text = Testinfo();
            AddHistory();
        }
        ...
        private void v_Click(object sender, EventArgs e)
        {
            ...
            if (variantValue.Text == "True")
            {
                variantValue.BackColor = Color.Green;
            }
            else
            {
                variantValue.BackColor = Color.Crimson;
            }
           Qnum++;
            this.Text = Testinfo();
